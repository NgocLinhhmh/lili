<div class="modal fade" id="form-add" tabindex="-1" role="dialog" aria-labelledby="formAddModelLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div id="title-form" class="modal-title" id="formAddModelLabel">書籍の新規登録</div>
                ...
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" style="display: flex">
                            <input type="file" class="form-control-file" id="exampleFormControlFile1">
                            <button class="btn-preview fas fa-eye"> プレビュー</button>
                        </div>
                    </div>
                    <div class="form-group row">
